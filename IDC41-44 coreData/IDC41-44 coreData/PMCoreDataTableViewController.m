...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([tableView.restorationIdentifier isEqualToString:@"students"]) {
        ...
        PMStudentCell *cell = [tableView dequeueReusableCellWithIdentifier:identifierStudents];
        ...
        PMCourseCell *cell = [tableView dequeueReusableCellWithIdentifier:identifierCourses];
        ...
        PMTeacherInfoCell *cell = [tableView dequeueReusableCellWithIdentifier:identifierTeachers];
